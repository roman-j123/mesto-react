  ...
  function handleClick() {
    ...
    return (
        <li className="elements__item">
          <button type="button" className={cardDeleteButton}></button>
          ...
          <div className="elements__card-container">
            ...
            <div className="elements__like-container">
              <button className={cardLikeButton} type="button" title="Оценить фотографию" aria-label="Поставить лайк"></button>
